...
public class RegisterSellerFragment extends Fragment {
    ...
    private RegisterSellerViewModel mViewModel;

    public static RegisterSellerFragment newInstance() {
        return new RegisterSellerFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(RegisterSellerViewModel.class);
