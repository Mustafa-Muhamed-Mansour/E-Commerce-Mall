...
public class RegisterAdminFragment extends Fragment {
    ...
    private RegisterAdminViewModel mViewModel;

    public static RegisterAdminFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(RegisterAdminViewModel.class);
